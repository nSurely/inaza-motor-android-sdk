...
import com.inaza.androidsdk.Exceptions.ValueException
...
import com.inaza.androidsdk.drivers.Drivers
import com.inaza.androidsdk.fleets.Fleets
import com.inaza.androidsdk.helpers.checkApiHandler
import com.inaza.androidsdk.models.drivers.CreateDriver
...
import com.inaza.androidsdk.vehicles.Vehicles
...
//    }
    ...
    suspend fun listVehicles(
        ...
        vehicles.listVehicles(regPlate, vin, isActive, isApproved, fullResponse, maxRecords)
            .collect { vehicle ->
                emit(vehicle)
            }
    ...
    suspend fun createVehicleType(vehicleType: VehicleType, sendWebhook: Boolean = true): VehicleType {
        return vehicles.createVehicleType(vehicleType, sendWebhook)
    }
...
//    }
    ...
    suspend fun createDriver(
        ...
        val createDriver = Json.decodeFromString<CreateDriver>(
            Json.encodeToString(driver).removeSuffix("}").plus(", \"password\":\"$password\"}")
        )
