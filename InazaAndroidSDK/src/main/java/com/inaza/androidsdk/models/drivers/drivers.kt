package com.inaza.androidsdk.models.drivers
...
import com.inaza.androidsdk.helpers.readPropertyOfAny
import com.inaza.androidsdk.models.billing.BillingAccount
import com.inaza.androidsdk.models.billing.BillingEvent
import com.inaza.androidsdk.models.billing.BillingEventStatus
import com.inaza.androidsdk.models.billing.BillingEventType
...
class Driver(
    ...
    suspend fun charge(amount: Int? = null, event: BillingEvent? = null): BillingEvent {
        ...
        val evnt = event ?: amount?.let {
            BillingEvent(
                amount = it,
                message = "Charge",
                type = BillingEventType.other
            )
        }
    ...
    suspend fun listCharges(
        ...
        this@Driver.api!!.batchFetch("drivers/${this@Driver.id}/billing-events", params)
            .collect { res ->
